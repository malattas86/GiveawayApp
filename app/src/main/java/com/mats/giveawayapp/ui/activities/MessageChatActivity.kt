...
import com.mats.giveawayapp.notifications.*
import com.mats.giveawayapp.ui.adapters.ChatsAdapter
import com.mats.giveawayapp.ui.fragments.APIService
...
class MessageChatActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        intent = intent
        userIdVisit = intent.getStringExtra(Constants.EXTRA_VISIT_USER_ID)!!
        userIdSender = FirestoreClass().getCurrentUserID()
        ...
        reference!!.addValueEventListener(object : ValueEventListener{
            ...
            {
                val user: User2? = p0.getValue(User2::class.java)

                binding.usernameMchat.text = user!!.getUsername()
                Picasso.get().load(user.getProfileImage()).into(binding.profileImageMchat)

                retrieveMessages(firebaseUser!!.uid, userIdVisit, user.getProfileImage())
            }
    ...
    private fun setupActionBar() {
        ...
        if (actionBar != null) {
            ...
            actionBar.title = ""
            actionBar.setHomeAsUpIndicator(com.mats.giveawayapp.R.drawable.ic_white_color_back_24dp)
        }

        binding.toolbarMessageChat.setNavigationOnClickListener { onBackPressed() }
    }
    ...
    private fun sendMessageToUser(senderId: String, receiverId: String?, message: String)
    {
        ...
        usersReference.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(p0: DataSnapshot)
            {
                val user = p0.getValue(User2::class.java)
                if (notify)
                {
                    ...
                    apiService!!.sendNotification(sender)
                        .enqueue(object : Callback<MyResponse>
                        {
                            ...
                            )
                            {
                                ...
                                {
                                    if (response.body()!!.success != 1) //TODO
                                    {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        {
            showProgressDialog(resources.getString(com.mats.giveawayapp.R.string.please_wait))
